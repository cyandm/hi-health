			...
			<div class="left-header">
				...
				<div class="lang-menu">
					<a href="#" class="lang-btn">
						<img src="<?= get_stylesheet_directory_uri() . '/assets/img/flag-fa.svg' ?>" alt="" id="btn-flag" class="lang-flag">
						<p id="lang-title" class="lang-title">
							Fa
						</p>
					</a>
				</div>
				...
				<div class="header-button">
					<a href="#" class="big-btn" id="send-req">
						<i class="icon-form"></i>
						<?= $btn_req ?>
					</a>
				</div>
