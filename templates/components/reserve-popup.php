	...
	<div class="reserve-popup__wrapper">
		...
		<div class="reserve-popup__content">
			...
			<form class="reserve-popup__form"
				...
				<input type="text"
					   name="country"
					   placeholder="<?php pll_e( 'form-country' ) ?>"
					   id="country">
				<input type="text"
					   name="telephone"
					   required
					   placeholder="<?php pll_e( 'form-phone' ) ?>"
					   id="telephone">
				<input type="text"
					   name="email"
				...
				<input type="file"
					   name="file"
					   placeholder="<?php pll_e( 'form-file' ) ?>"
					   id="file">
				<textarea name="description"
						  placeholder="<?php pll_e( 'form-message' ) ?>"
