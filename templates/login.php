...
<main class="login-page container" id="login-page">
	...
	<?php if ($registration_enabled) : ?>
		<div class="register">
			<div class="register-form">
				<form id="cyn_registration_form" action="" method="POST">
					<p>
						<label for="cyn_user_login"><?= pll__('username') . ':' ?></label>
						<input name="cyn_user_login" id="cyn_user_login" type="text" />
					</p>
					<p>
						<label for="cyn_user_email">
							<?php pll__('email') . ':' ?>
						</label>
						<input name="cyn_user_email" id="cyn_user_email" type="email" />
					</p>

					<p>
						<label for="password"><?= pll__('password') . ':' ?></label>
						<input name="cyn_user_pass" id="password" type="password" />
					</p>
					<p>
						<label for="password_again"><?= pll__('repeat-password') . ':' ?></label>
						<input name="cyn_user_pass_confirm" id="password_again" type="password" />
					</p>
					<p>
						<input type="submit" value="<?php pll_e('login'); ?>" />
					</p>
