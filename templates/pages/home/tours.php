...
<section class="tours">
	...
	<div class="tours__header container">
		...
		<a class="btn" variant="secondary" size="big" href="<?= $button['button_link'] ?>">
			<?= $button['button_text'] ?>
		</a>
	</div>
	...
	<div class="tours__posts">
		...
		<div class="swiper" dir="rtl" id="homePageTours">
			...
			<div class="swiper-wrapper">
				...
				?>
					...
					<div class="swiper-slide 
							<?= $is_pic ? 'tours__post-picture' : 'tours__post-video' ?>" style="--bg-url:url(<?= $cover ?>)">
